...
function generateResume() {
   ...
   let linkedinElement = document.querySelector("#preview-linkedin");

   linkedinElement.href = linkedinField;

   linkedinElement.textContent = linkedinField || "linkedin.com/in/username";
